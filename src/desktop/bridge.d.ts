...
declare global {
  interface Window {
    suqDesktop?: {
      aiRequest: (request: { requestId?: string; url: string; method: 'GET' | 'POST'; key?: string; body?: string; upload?: { base64: string; name: string; type: string } }) => Promise<{ status: number; contentType: string; base64: string }>
